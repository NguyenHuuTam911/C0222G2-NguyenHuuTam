...
<div class="container-fluid">
    ...
    <div class="col-9">
      <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
          ...
          <div class="carousel-item">
            <img src="https://danangfantasticity.com/wp-content/uploads/2021/02/Furama-resort-danang-103-105-vo-nguyen-giap-da-nang-fly-cam.jpg" class="d-block" width="100%" height="505px" alt="">
            <div class="carousel-caption d-none d-md-block text-dark">
              <h3>FuraMa</h3>
  ...
  <footer class="container-fluid text-center bg-dark p-2 text-light" style="height: 24px">
    <p class="text-light">Furama Resort - &copy; Copyright by 2022</p>
  </footer>
